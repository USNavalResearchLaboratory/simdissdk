...
2.  Configuring the build:
  ...
  **NOTE: If you have installed all of the third party dependencies in the same
  directory(for example if you download 3rd party dependecies from [Releases page](https://github.com/USNavalResearchLaboratory/simdissdk/releases), extract it and put the "3rd" folder in the source code directory not the build directory), the SIMDIS SDK CMake configuration should locate the files.  You
