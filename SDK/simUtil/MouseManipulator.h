...
public:
  ...
  /** Mouse button pushed, returns non-zero on handled */
  virtual int push(const osgGA::GUIEventAdapter& ea, osgGA::GUIActionAdapter& aa) { return 0; }
  /** Mouse button released, returns non-zero on handled */
  virtual int release(const osgGA::GUIEventAdapter& ea, osgGA::GUIActionAdapter& aa) { return 0; }
  /** Mouse being moved, returns non-zero on handled */
  virtual int move(const osgGA::GUIEventAdapter& ea, osgGA::GUIActionAdapter& aa) { return 0; }
  /** Mouse being dragged, returns non-zero on handled */
  virtual int drag(const osgGA::GUIEventAdapter& ea, osgGA::GUIActionAdapter& aa) { return 0; }
  /** Mouse button double clicked, returns non-zero on handled */
