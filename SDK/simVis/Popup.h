...
namespace simVis
{
  ...
  */
  // TODO: Rename to EntityPopup once this class is complete
  class SDKVIS_EXPORT EntityPopup2 : public osg::MatrixTransform
  {
  public:
    EntityPopup2();
    ...
    /** Return the class name */ // TODO: Fix name once this class is complete
    virtual const char* className() const { return "EntityPopup2"; }
  ...
  */
  // TODO: temporary class name during development. Largely follows implementation from PopupHandler, with main differences being in the usage
  // of PositionCallback and in updatePopupFromView()
  class SDKVIS_EXPORT PopupHandler2 : public osgGA::GUIEventHandler
  {
  public:
    /**
     ...
     */
    PopupHandler2(Picker* picker, View* view);
     ...
     * @param view View on which to show the popup
     */
    explicit PopupHandler2(SceneManager* scene, View* view = nullptr);
  ...
  public: // GUIEventHandler interface
    ...
    /** Return the class name */ // TODO: fix name once this class is complete and replaces PopupHandler
    virtual const char* className() const { return "PopupHandler2"; }

  private: // methods
    virtual ~PopupHandler2(); // reference counted object
  ...
  private:
    ...
    osg::ref_ptr<EntityPopup2>         popup2_;               ///< managed EntityPopup
