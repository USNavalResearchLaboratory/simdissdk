...
namespace simVis
{
  ...
  private: // methods
    ...
    */
    ...
    /// Update the "altitude mode" settings that draws a line from the platform
    /// to the ground
    void updateAltMode_(bool enabled, const simData::PlatformUpdateSlice& updateSlice);
    void updateAltModePositionAndAppearance_(const osg::Matrixd& mat, const osg::Vec4& color);
