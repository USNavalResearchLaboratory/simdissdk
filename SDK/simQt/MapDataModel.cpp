...
public:
  ...
  QVariant color() const override
  {
    return QVariant();
  }

  /** @copydoc  MapDataModel::Item::layerTypeRole */
  MapDataModel::MapChildren layerTypeRole() const override
  {
    return MapDataModel::CHILD_NONE;
  }

  /** @copydoc  MapDataModel::Item::layerPtr */
  QVariant layerPtr() const override
  {
    return QVariant();
  }
...
public:
  ...
  /** @copydoc  MapDataModel::Item::parent */
  MapDataModel::Item* parent() const override
  {
    return parent_;
  }
...
public:
  ...
  void onLayerMoved(osgEarth::Layer* layer, unsigned int oldIndex, unsigned int newIndex) override
  {
#ifdef HAVE_SIMUTIL
