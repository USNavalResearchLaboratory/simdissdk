...
namespace simCore
{
  ...
  * @param[in ] frequency Frequency of antenna pattern (GHz)
  * @param[in ] frequencythreshold Frequency threshold between different frequencies in pattern (GHz)
  * @return boolean, true:success, false on failure
  * @pre sap valid param
  */
  SDKCORE_EXPORT bool readPattern(SymmetricAntennaPattern *sap, std::istream &in, const std::string &name, double frequency, double frequencythreshold = 0.5);
  ...
  * @pre sap valid param
  */
  SDKCORE_EXPORT bool readPattern(SymmetricAntennaPattern *sap, const std::string &filename, const std::string &name, double frequency, double frequencythreshold = 0.5);
  ...
  * @pre sap valid param
  */
  SDKCORE_EXPORT bool readPattern(SymmetricGainAntPattern *sap, std::istream &in, double frequency, double frequencythreshold = 0.5);
  ...
  * @pre sap valid param
  */
  SDKCORE_EXPORT bool readPattern(SymmetricGainAntPattern *sap, const std::string &filename, double frequency, double frequencythreshold = 0.5);
