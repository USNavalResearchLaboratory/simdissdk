...
int canConvert(const std::string& timeString, bool expectSeconds, bool expectMinutes, bool expectHours,
               bool expectMonthDay, bool expectOrdinal, bool expectDtg, const simCore::TimeStamp expectRef1971=simCore::TimeStamp(1970, 0))
{
  int rv = 0;
  ...
  bool convertable = expectSeconds || expectMinutes || expectHours || expectMonthDay || expectOrdinal || expectDtg;
...
int canConvertTest()
{
  int rv = 0;
  // Good seconds
  rv += SDK_ASSERT(0 == canConvert("55.45", true, false, false, false, false, false, simCore::TimeStamp(1971, 55.45)));
  rv += SDK_ASSERT(0 == canConvert("55.", true, false, false, false, false, false, simCore::TimeStamp(1971, 55)));
  rv += SDK_ASSERT(0 == canConvert("55", true, false, false, false, false, false, simCore::TimeStamp(1971, 55)));
  rv += SDK_ASSERT(0 == canConvert("-1.0", true, false, false, false, false, false, simCore::TimeStamp(1971, -1)));
  rv += SDK_ASSERT(0 == canConvert("-1", true, false, false, false, false, false, simCore::TimeStamp(1971, -1)));
  rv += SDK_ASSERT(0 == canConvert("\" 20.0\"", true, false, false, false, false, false, simCore::TimeStamp(1971, 20)));
  rv += SDK_ASSERT(0 == canConvert("\" 20.0  \"", true, false, false, false, false, false, simCore::TimeStamp(1971, 20)));
  rv += SDK_ASSERT(0 == canConvert("20", true, false, false, false, false, false, simCore::TimeStamp(1971, 20)));
  rv += SDK_ASSERT(0 == canConvert("\" -1.0\"", true, false, false, false, false, false, simCore::TimeStamp(1971, -1)));
  rv += SDK_ASSERT(0 == canConvert("\" -1.0 \"", true, false, false, false, false, false, simCore::TimeStamp(1971, -1)));
  rv += SDK_ASSERT(0 == canConvert(".1", true, false, false, false, false, false, simCore::TimeStamp(1971, 0.1)));
  rv += SDK_ASSERT(0 == canConvert("-.1", true, false, false, false, false, false, simCore::TimeStamp(1971, -0.1)));
  rv += SDK_ASSERT(0 == canConvert("+1.0", true, false, false, false, false, false, simCore::TimeStamp(1971, 1)));
  rv += SDK_ASSERT(0 == canConvert("+125.2", true, false, false, false, false, false, simCore::TimeStamp(1971, 125.2)));
  rv += SDK_ASSERT(0 == canConvert("+42", true, false, false, false, false, false, simCore::TimeStamp(1971, 42)));
  rv += SDK_ASSERT(0 == canConvert("+.5", true, false, false, false, false, false, simCore::TimeStamp(1971, .5)));
  // Bad seconds
  rv += SDK_ASSERT(0 == canConvert(".55.", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("5.55.5", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("5..55", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("5,55", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("5.+55", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("5.-55", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("5.55$", false, false, false, false, false, false));
  ...
  // Good minutes
  rv += SDK_ASSERT(0 == canConvert("1:55.45", false, true, false, false, false, false, simCore::TimeStamp(1971, 115.45)));
  rv += SDK_ASSERT(0 == canConvert("1:55.", false, true, false, false, false, false, simCore::TimeStamp(1971, 115)));
  rv += SDK_ASSERT(0 == canConvert("1:55", false, true, false, false, false, false, simCore::TimeStamp(1971, 115)));
  rv += SDK_ASSERT(0 == canConvert("\" 24:23.15 \"", false, true, false, false, false, false, simCore::TimeStamp(1971, 1463.15)));
  rv += SDK_ASSERT(0 == canConvert("\"   24:23.15\"", false, true, false, false, false, false, simCore::TimeStamp(1971, 1463.15)));
  rv += SDK_ASSERT(0 == canConvert("\"24:23.15  \"", false, true, false, false, false, false, simCore::TimeStamp(1971, 1463.15)));
  rv += SDK_ASSERT(0 == canConvert("+2:00", false, true, false, false, false, false, simCore::TimeStamp(1971, 120)));
  rv += SDK_ASSERT(0 == canConvert("+2:0.2", false, true, false, false, false, false, simCore::TimeStamp(1971, 120.2)));
  rv += SDK_ASSERT(0 == canConvert("+2:24.5", false, true, false, false, false, false, simCore::TimeStamp(1971, 144.5)));
  // Bad minutes
  rv += SDK_ASSERT(0 == canConvert("++2:24.5", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("+:24.5", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert(":24.5", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("24.5:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("24:", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("24:+0", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("24:.5", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("24:65.5", false, false, false, false, false, false));

  // Good hours
  rv += SDK_ASSERT(0 == canConvert("10:01:55.45", false, false, true, false, false, false, simCore::TimeStamp(1971, 36115.45)));
  rv += SDK_ASSERT(0 == canConvert("10:1:55.", false, false, true, false, false, false, simCore::TimeStamp(1971, 36115)));
  rv += SDK_ASSERT(0 == canConvert("10:1:55", false, false, true, false, false, false, simCore::TimeStamp(1971, 36115)));
  rv += SDK_ASSERT(0 == canConvert("\"  10:10:12.2 \"", false, false, true, false, false, false, simCore::TimeStamp(1971, 36612.2)));
  rv += SDK_ASSERT(0 == canConvert("\"10:10:12.2  \"", false, false, true, false, false, false, simCore::TimeStamp(1971, 36612.2)));
  rv += SDK_ASSERT(0 == canConvert("\"    10:10:12.2\"", false, false, true, false, false, false, simCore::TimeStamp(1971, 36612.2)));
  rv += SDK_ASSERT(0 == canConvert("+31:00:00", false, false, true, false, false, false, simCore::TimeStamp(1971, 111600)));
  rv += SDK_ASSERT(0 == canConvert("+31:0:0.32", false, false, true, false, false, false, simCore::TimeStamp(1971, 111600.32)));
  rv += SDK_ASSERT(0 == canConvert("+31:43:0.13", false, false, true, false, false, false, simCore::TimeStamp(1971, 114180.13)));
  // Bad hours
  rv += SDK_ASSERT(0 == canConvert("++1:2:24.5", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("+1::24.5", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1::24.5", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1:24.5:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1:24:", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1:24:+0", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1:24:.5", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1:24:65.5", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1::35.5", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("::35.5", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("::", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1::", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1:1:", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1::1", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1:60:1", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1:59:61", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1:5.9:5", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1.1:5:5", false, false, false, false, false, false));

  // Good ordinal
  rv += SDK_ASSERT(0 == canConvert("10 2004 10:1:55.45", false, false, false, false, true, false,
    simCore::TimeStamp(2004, 9*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("10 2004 10:1:55.", false, false, false, false, true, false,
    simCore::TimeStamp(2004, 9*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("10 2004 10:1:55", false, false, false, false, true, false,
    simCore::TimeStamp(2004, 9*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("010 2004 10:1:55", false, false, false, false, true, false,
    simCore::TimeStamp(2004, 9*86400 + 10*3600 + 1*60 + 55)));;
  rv += SDK_ASSERT(0 == canConvert("1 2004 10:1:55", false, false, false, false, true, false,
    simCore::TimeStamp(2004, 0*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("001 2004 10:1:55", false, false, false, false, true, false,
    simCore::TimeStamp(2004, 0*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("100 2004 10:1:55", false, false, false, false, true, false,
    simCore::TimeStamp(2004, 99*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("365 2004 10:1:55", false, false, false, false, true, false,
    simCore::TimeStamp(2004, 364*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("366 2004 10:1:55", false, false, false, false, true, false,
    simCore::TimeStamp(2004, 365*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("1 2004 23:59:59", false, false, false, false, true, false,
    simCore::TimeStamp(2004, 86399)));
  rv += SDK_ASSERT(0 == canConvert("\"   001   2004    10:14:05.5   \"", false, false, false, false, true, false,
    simCore::TimeStamp(2004, 0*86400 + 10*3600 + 14*60 + 5.5)));
  // Bad ordinal
  rv += SDK_ASSERT(0 == canConvert("0001 2004 22:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("001 1899 22:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("000 2004 22:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("001 11981 22:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("001 -1970 22:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("001 +1970 22:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("+10 1970 22:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("-10 1970 22:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("10 1970 -22:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("10 1970 +22:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("10 1970 24:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1.0 1970 22:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("10 1970.0 22:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("10 19.8 22:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("10 1970 220:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("366 2005 20:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("000 1971 10:00:00", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("001 1971 10:00:00 0", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("001 1971 00:00", false, false, false, false, false, false));

  // Good month/day
  rv += SDK_ASSERT(0 == canConvert("Jan 1 2004 00:01:00.45", false, false, false, true, false, false,
    simCore::TimeStamp(2004, 60.45)));
  rv += SDK_ASSERT(0 == canConvert("Jan 10 2004 10:1:55.45", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(0, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("Jan 10 2004 10:1:55.", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(0, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("Jan 10 2004 10:1:55", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(0, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("FEB 10 2004 10:1:55.45", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(1, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("mar 10 2004 10:1:55.", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(2, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("APr 10 2004 10:1:55", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(3, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("MaY 10 2004 10:1:55.45", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(4, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("jun 10 2004 10:1:55.", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(5, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("jul 10 2004 10:1:55", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(6, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("aug 10 2004 10:1:55.45", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(7, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("sep 10 2004 10:1:55.", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(8, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("oct 10 2004 10:1:55", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(9, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("NOV 10 2004 10:1:55.45", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(10, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("Dec 10 2004 10:1:55.", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(11, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("Jan 10 2004 10:1:55.", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(0, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("\"  Jul  10    2004    10:01:01.5 \"", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(6, 10, 104)*86400 + 10*3600 + 1*60 + 1.5)));
  rv += SDK_ASSERT(0 == canConvert("Feb 29 2004 10:1:55.45", false, false, false, true, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(1, 29, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("Jan 02 2004 01:01:01", false, false, false, true, false, false,
    simCore::TimeStamp(2004, 90061)));
  // Bad month/day
  rv += SDK_ASSERT(0 == canConvert("January 10 2004 10:1:55.45", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("Ja 10 2004 10:1:55.45", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("Ja. 10 2004 10:1:55.45", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("Jan 1.0 2004 10:1:55.45", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("Jan 10 2.04 10:1:55.45", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("Jan 32 2.04 10:1:55.45", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("Feb 29 2005 10:1:55.45", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("Feb 028 2005 10:1:55.45", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("Feb 28 2005 10:1:55.45 0", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("Feb 28 2005 01:55", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("Feb 28 05 01:55:00", false, false, false, false, false, false));

  // Good DTG
  rv += SDK_ASSERT(0 == canConvert("010000:10 Z Jan13", false, false, false, false, false, true,
    simCore::TimeStamp(2013, simCore::getYearDay(0, 1, 113)*86400 + 0*3600 + 0*60 + 10)));
  rv += SDK_ASSERT(0 == canConvert("211505:30.5 Z Jan13", false, false, false, false, false, true,
    simCore::TimeStamp(2013, simCore::getYearDay(0, 21, 113)*86400 + 15*3600 + 5*60 + 30.5)));
  rv += SDK_ASSERT(0 == canConvert("211505:30.5 Z FEB06", false, false, false, false, false, true,
    simCore::TimeStamp(2006, simCore::getYearDay(1, 21, 106)*86400 + 15*3600 + 5*60 + 30.5)));
  rv += SDK_ASSERT(0 == canConvert("020801:00. Z APR92", false, false, false, false, false, true,
    simCore::TimeStamp(1992, simCore::getYearDay(3, 2, 92)*86400 + 8*3600 + 1*60 + 0)));
  rv += SDK_ASSERT(0 == canConvert("301600:45 Z JUN12", false, false, false, false, false, true,
    simCore::TimeStamp(2012, simCore::getYearDay(5, 30, 112)*86400 + 16*3600 + 0*60 + 45)));
  rv += SDK_ASSERT(0 == canConvert("191934:14.123 Z FEB70", false, false, false, false, false, true,
    simCore::TimeStamp(1970, simCore::getYearDay(1, 19, 70)*86400 + 19*3600 + 34*60 + 14.123)));
  rv += SDK_ASSERT(0 == canConvert("191934:14.123 Z FEB69", false, false, false, false, false, true,
    simCore::TimeStamp(2069, simCore::getYearDay(1, 19, 69)*86400 + 19*3600 + 34*60 + 14.123)));
  rv += SDK_ASSERT(0 == canConvert("170249:51.5832 Z MAY04", false, false, false, false, false, true,
    simCore::TimeStamp(2004, simCore::getYearDay(4, 17, 104)*86400 + 2*3600 + 49*60 + 51.5832)));
  rv += SDK_ASSERT(0 == canConvert("170249:59.5832 Z MAY04", false, false, false, false, false, true,
    simCore::TimeStamp(2004, simCore::getYearDay(4, 17, 104)*86400 + 2*3600 + 49*60 + 59.5832)));
  rv += SDK_ASSERT(0 == canConvert("170259:51.5832 Z MAY04", false, false, false, false, false, true,
    simCore::TimeStamp(2004, simCore::getYearDay(4, 17, 104)*86400 + 2*3600 + 59*60 + 51.5832)));
  rv += SDK_ASSERT(0 == canConvert("170249:51.5832   Z   MAY04", false, false, false, false, false, true,
    simCore::TimeStamp(2004, simCore::getYearDay(4, 17, 104)*86400 + 2*3600 + 49*60 + 51.5832)));
  rv += SDK_ASSERT(0 == canConvert("291001:55.45 Z FEB04", false, false, false, false, false, true,
    simCore::TimeStamp(2004, simCore::getYearDay(1, 29, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  // Bad DTG
  rv += SDK_ASSERT(0 == canConvert("170249:51 Z MAY+4", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("320249:51 Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("290249:51 Z FEB05", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("-170249:51 Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("000249:51 Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("+170249:51 Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("17+0249:51 Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("1702+49:51 Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("170249:+51 Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("170249:55.1. Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("170249:5 Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("170249:5. Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("170249:5.1 Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("170249:60 Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("170260:50 Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("170250:60 Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("172449:50 Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("172.149:50 Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("17214:50 Z MAY04", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("012014:50 Z MAY4", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("012014:50 z MAY14", false, false, false, false, false, false));
  rv += SDK_ASSERT(0 == canConvert("012014:50 W MAY14", false, false, false, false, false, false));

  // Legacy ordinal with no year
  rv += SDK_ASSERT(0 == canConvert("001 00:00:00.00000", false, false, false, false, false, false,
    simCore::TimeStamp(1971, 0)));
  rv += SDK_ASSERT(0 == canConvert("100 10:1:55.45", false, false, false, false, false, false,
    simCore::TimeStamp(1971, 99*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("100 10:01:55.", false, false, false, false, false, false,
    simCore::TimeStamp(1971, 99*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("001 14:03:53.233", false, false, false, false, false, false,
    simCore::TimeStamp(1971, 0*86400 + 14*3600 + 3*60 + 53.233)));
  rv += SDK_ASSERT(0 == canConvert("100 10:1:55.45", false, false, false, false, false, false,
    simCore::TimeStamp(1971, 99*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("100 10:01:55.000", false, false, false, false, false, false,
    simCore::TimeStamp(1971, 99*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("100 10:1:55", false, false, false, false, false, false,
    simCore::TimeStamp(1971, 99*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("100 10:1:55", false, false, false, false, false, false,
    simCore::TimeStamp(1971, 99*86400 + 10*3600 + 1*60 + 55)));

  // Legacy ordinal with year at the end
  rv += SDK_ASSERT(0 == canConvert("103 10:1:55.45 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, 102*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("103 10:1:55. 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, 102*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("103 10:1:55 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, 102*86400 + 10*3600 + 1*60 + 55)));

  // Legacy Month/Day format with year at end
  rv += SDK_ASSERT(0 == canConvert("Jan 10 10:1:55.45 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(0, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("Jan 10 10:1:55 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(0, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("FEB 10 10:01:55.45 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(1, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("mar 10 10:1:55. 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(2, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("APr 10 10:1:55 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(3, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("MaY 10 10:1:55.45 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(4, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("jun 10 10:01:55. 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(5, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("jul 10 10:1:55 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(6, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("aug 10 10:1:55.45 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(7, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("sep 10 10:1:55. 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(8, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("oct 10 10:01:55 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(9, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("NOV 10 10:1:55.45 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(10, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("Dec 10 10:1:55. 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(11, 10, 104)*86400 + 10*3600 + 1*60 + 55)));

  // Legacy Monthday/Month/Year format
  rv += SDK_ASSERT(0 == canConvert("10 Jan 2004 10:1:55.45", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(0, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("10 Jan 2004 10:1:55.", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(0, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("10 Jan 2004 10:1:55", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(0, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("10 FEB 2004 10:1:55.45", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(1, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("10 mar 2004 10:1:55.", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(2, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("10 APr 2004 10:1:55", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(3, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("10 MaY 2004 10:1:55.45", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(4, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("10 jun 2004 10:1:55.", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(5, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("10 jul 2004 10:1:55", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(6, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("10 aug 2004 10:1:55.45", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(7, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("10 sep 2004 10:1:55.", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(8, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("10 oct 2004 10:1:55", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(9, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("10 NOV 2004 10:1:55.45", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(10, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("10 Dec 2004 10:1:55.", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(11, 10, 104)*86400 + 10*3600 + 1*60 + 55)));

  // Legacy Weekday format with year
  rv += SDK_ASSERT(0 == canConvert("MON Jan 10 10:1:55.45 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(0, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("WeD Jan 10 10:1:55 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(0, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("thu FEB 10 10:01:55.45 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(1, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("fRi mar 10 10:1:55. 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(2, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("SAt APr 10 10:1:55 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(3, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("suN MaY 10 10:1:55.45 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(4, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("Mon jun 10 10:01:55. 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(5, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("Tue jul 10 10:1:55 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(6, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("Wed aug 10 10:1:55.45 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(7, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("Thu sep 10 10:1:55. 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(8, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("Fri oct 10 10:01:55 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(9, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("Sat NOV 10 10:1:55.45 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(10, 10, 104)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("Sun Dec 10 10:1:55. 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(11, 10, 104)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("Tue Jan 10 10:1:55. 2004", false, false, false, false, false, false,
    simCore::TimeStamp(2004, simCore::getYearDay(0, 10, 104)*86400 + 10*3600 + 1*60 + 55)));

  // Legacy Weekday format without year
  rv += SDK_ASSERT(0 == canConvert("Tue Jan 10 10:1:55.", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(0, 10, 71)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("MON Jan 10 10:1:55.45", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(0, 10, 71)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("WeD Jan 10 10:1:55", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(0, 10, 71)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("thu FEB 10 10:01:55.45", false, false, false, false, false, false,
  ...
  rv += SDK_ASSERT(0 == canConvert("fRi mar 10 10:1:55.", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(2, 10, 71)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("SAt APr 10 10:1:55", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(3, 10, 71)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("suN MaY 10 10:1:55.45", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(4, 10, 71)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("Mon jun 10 10:01:55.", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(5, 10, 71)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("Tue jul 10 10:1:55", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(6, 10, 71)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("Wed aug 10 10:1:55.45", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(7, 10, 71)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("Thu sep 10 10:1:55.", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(8, 10, 71)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("Fri oct 10 10:01:55", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(9, 10, 71)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("Sat NOV 10 10:1:55.45", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(10, 10, 71)*86400 + 10*3600 + 1*60 + 55.45)));
  rv += SDK_ASSERT(0 == canConvert("Sun Dec 10 10:1:55.", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(11, 10, 71)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("Thr jul 8 10:01:55", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(6, 8, 71)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("\"Thr Jul 8 10:01:55\"", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(6, 8, 71)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("\"\"\"Thu Jul 8 10:01:55\"\"\"", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(6, 8, 71)*86400 + 10*3600 + 1*60 + 55)));
  rv += SDK_ASSERT(0 == canConvert("Thu  Jul   15     10:01:51.55", false, false, false, false, false, false,
    simCore::TimeStamp(1971, simCore::getYearDay(6, 15, 71)*86400 + 10*3600 + 1*60 + 51.55)));
  rv += SDK_ASSERT(0 == canConvert("\"   Thu   Jul 10   10:01:51.55   \"", false, false, false, false, false, false,
