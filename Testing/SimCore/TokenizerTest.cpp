...
namespace
{
  ...
  int testExpandEnv()
  {
    ...
    rv += testExpandEnv(" $(ENV_NO_EXIST) ", " $(ENV_NO_EXIST) ");
    ...
    rv += testExpandEnv("$(SIMDIS_HOME)/$(TEST_HOST_PLAT)/$(TEST_HOST_OS)/test", env("SIMDIS_HOME") + "/$(TEST_HOST_PLAT)/" + env("TEST_HOST_OS") + "/test");
